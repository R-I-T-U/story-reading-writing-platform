...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id']) && isset($_COOKIE['user_id'])) {
        ...
        // Process the uploaded file (cover image)
        $target_dir = "uploads/";
        ...
        // Now, you can do further processing with the data (e.g., store it in a database)
        ...
        echo "<p>Cover Image: <img src='$target_file' alt='Cover Image'></p>";
